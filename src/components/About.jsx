      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-1/2 relative flex justify-center" data-aos="fade-right">
            ...
            <div className="absolute w-96 h-96 bg-air-blue/20 rounded-full blur-3xl -z-10 animate-pulse"></div>
            <div className="absolute w-80 h-80 bg-deep-teal/10 rounded-full blur-3xl -z-10 translate-x-12 translate-y-12"></div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div 
              key={index}
              className="bg-gray-50 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
              data-aos="fade-up"
            ...
            >
              <div className="h-48 overflow-hidden relative">
                ...
                />
                <div className="absolute bottom-0 right-0 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-tl-xl text-2xl">
                  {item.emoji}
                </div>
              </div>
              <div className="p-6">
