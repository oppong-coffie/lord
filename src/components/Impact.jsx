...
import { FaGlobe, FaHandHoldingHeart, FaUsers } from 'react-icons/fa';

const Impact = () => {
  const impacts = [
    {
      icon: <FaGlobe className="text-4xl text-[var(--color-air-blue)]" />,
      title: 'Global Policy',
    ...
    {
      icon: <FaHandHoldingHeart className="text-4xl text-[var(--color-deep-teal)]" />,
    ...
    {
      icon: <FaUsers className="text-4xl text-[var(--color-air-blue)]" />,
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {impacts.map((item, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-[var(--color-deep-teal)] mb-4">
                {item.title}
              </h3>
